...
// Tue May  9 14:45:50 2023 by ROOT version 6.22/08
// from TTree Delphes/Analysis tree
// found on file: /home/bashiri/Downloads/FPMC_bSM_14tev_AAAZeft_A1A_0E0_A2A_1E-13_pt50-noHADR_3.5563044069199587E-004_Zmumu.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxGenProton = 781;
   static constexpr Int_t kMaxParticle = 24;
   static constexpr Int_t kMaxVertex = 259;
   static constexpr Int_t kMaxGenJet = 4;
   static constexpr Int_t kMaxGenJetAK8 = 2;
   static constexpr Int_t kMaxGenMissingET = 1;
   static constexpr Int_t kMaxParticleFlowCandidate = 230;
   static constexpr Int_t kMaxPhoton = 33;
   static constexpr Int_t kMaxPhotonLoose = 4;
   static constexpr Int_t kMaxPhotonMedium = 5;
   static constexpr Int_t kMaxPhotonTight = 3;
   static constexpr Int_t kMaxElectron = 27;
   static constexpr Int_t kMaxElectronLoose = 2;
   static constexpr Int_t kMaxElectronMedium = 1;
   static constexpr Int_t kMaxElectronTight = 2;
   static constexpr Int_t kMaxMuon = 14;
   static constexpr Int_t kMaxMuonLoose = 4;
   static constexpr Int_t kMaxMuonMedium = 4;
   static constexpr Int_t kMaxMuonTight = 4;
   static constexpr Int_t kMaxJetPUPPI = 7;
   static constexpr Int_t kMaxJetPUPPIAK8 = 2;
   static constexpr Int_t kMaxJetPUPPILoose = 4;
   static constexpr Int_t kMaxJetPUPPITight = 4;
   ...
   Int_t           Weight_size;
   Int_t           GenProton_;
   UInt_t          GenProton_fUniqueID[kMaxGenProton];   //[GenProton_]
   UInt_t          GenProton_fBits[kMaxGenProton];   //[GenProton_]
   Int_t           GenProton_PID[kMaxGenProton];   //[GenProton_]
   Int_t           GenProton_Status[kMaxGenProton];   //[GenProton_]
   Int_t           GenProton_IsPU[kMaxGenProton];   //[GenProton_]
   Int_t           GenProton_M1[kMaxGenProton];   //[GenProton_]
   Int_t           GenProton_M2[kMaxGenProton];   //[GenProton_]
   Int_t           GenProton_D1[kMaxGenProton];   //[GenProton_]
   Int_t           GenProton_D2[kMaxGenProton];   //[GenProton_]
   Int_t           GenProton_Charge[kMaxGenProton];   //[GenProton_]
   Float_t         GenProton_Mass[kMaxGenProton];   //[GenProton_]
   Float_t         GenProton_E[kMaxGenProton];   //[GenProton_]
   Float_t         GenProton_Px[kMaxGenProton];   //[GenProton_]
   Float_t         GenProton_Py[kMaxGenProton];   //[GenProton_]
   Float_t         GenProton_Pz[kMaxGenProton];   //[GenProton_]
   Float_t         GenProton_P[kMaxGenProton];   //[GenProton_]
   Float_t         GenProton_PT[kMaxGenProton];   //[GenProton_]
   Float_t         GenProton_Eta[kMaxGenProton];   //[GenProton_]
   Float_t         GenProton_Phi[kMaxGenProton];   //[GenProton_]
   Float_t         GenProton_Rapidity[kMaxGenProton];   //[GenProton_]
   Float_t         GenProton_T[kMaxGenProton];   //[GenProton_]
   Float_t         GenProton_X[kMaxGenProton];   //[GenProton_]
   Float_t         GenProton_Y[kMaxGenProton];   //[GenProton_]
   Float_t         GenProton_Z[kMaxGenProton];   //[GenProton_]
   Int_t           GenProton_size;
   Int_t           Particle_;
   ...
   TBranch        *b_GenProton_;   //!
   TBranch        *b_GenProton_fUniqueID;   //!
   TBranch        *b_GenProton_fBits;   //!
   TBranch        *b_GenProton_PID;   //!
   TBranch        *b_GenProton_Status;   //!
   TBranch        *b_GenProton_IsPU;   //!
   TBranch        *b_GenProton_M1;   //!
   TBranch        *b_GenProton_M2;   //!
   TBranch        *b_GenProton_D1;   //!
   TBranch        *b_GenProton_D2;   //!
   TBranch        *b_GenProton_Charge;   //!
   TBranch        *b_GenProton_Mass;   //!
   TBranch        *b_GenProton_E;   //!
   TBranch        *b_GenProton_Px;   //!
   TBranch        *b_GenProton_Py;   //!
   TBranch        *b_GenProton_Pz;   //!
   TBranch        *b_GenProton_P;   //!
   TBranch        *b_GenProton_PT;   //!
   TBranch        *b_GenProton_Eta;   //!
   TBranch        *b_GenProton_Phi;   //!
   TBranch        *b_GenProton_Rapidity;   //!
   TBranch        *b_GenProton_T;   //!
   TBranch        *b_GenProton_X;   //!
   TBranch        *b_GenProton_Y;   //!
   TBranch        *b_GenProton_Z;   //!
   TBranch        *b_GenProton_size;   //!
   TBranch        *b_Particle_;   //!
   ...
   virtual void     Loop(double cross_section, TString puflag, TString xiflag, TString ssig, int timepr);
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/home/bashiri/Downloads/FPMC_bSM_14tev_AAAZeft_A1A_0E0_A2A_1E-13_pt50-noHADR_3.5563044069199587E-004_Zmumu.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/home/bashiri/Downloads/FPMC_bSM_14tev_AAAZeft_A1A_0E0_A2A_1E-13_pt50-noHADR_3.5563044069199587E-004_Zmumu.root");
      }
...
void analysis::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("GenProton", &GenProton_, &b_GenProton_);
   fChain->SetBranchAddress("GenProton.fUniqueID", GenProton_fUniqueID, &b_GenProton_fUniqueID);
   fChain->SetBranchAddress("GenProton.fBits", GenProton_fBits, &b_GenProton_fBits);
   fChain->SetBranchAddress("GenProton.PID", GenProton_PID, &b_GenProton_PID);
   fChain->SetBranchAddress("GenProton.Status", GenProton_Status, &b_GenProton_Status);
   fChain->SetBranchAddress("GenProton.IsPU", GenProton_IsPU, &b_GenProton_IsPU);
   fChain->SetBranchAddress("GenProton.M1", GenProton_M1, &b_GenProton_M1);
   fChain->SetBranchAddress("GenProton.M2", GenProton_M2, &b_GenProton_M2);
   fChain->SetBranchAddress("GenProton.D1", GenProton_D1, &b_GenProton_D1);
   fChain->SetBranchAddress("GenProton.D2", GenProton_D2, &b_GenProton_D2);
   fChain->SetBranchAddress("GenProton.Charge", GenProton_Charge, &b_GenProton_Charge);
   fChain->SetBranchAddress("GenProton.Mass", GenProton_Mass, &b_GenProton_Mass);
   fChain->SetBranchAddress("GenProton.E", GenProton_E, &b_GenProton_E);
   fChain->SetBranchAddress("GenProton.Px", GenProton_Px, &b_GenProton_Px);
   fChain->SetBranchAddress("GenProton.Py", GenProton_Py, &b_GenProton_Py);
   fChain->SetBranchAddress("GenProton.Pz", GenProton_Pz, &b_GenProton_Pz);
   fChain->SetBranchAddress("GenProton.P", GenProton_P, &b_GenProton_P);
   fChain->SetBranchAddress("GenProton.PT", GenProton_PT, &b_GenProton_PT);
   fChain->SetBranchAddress("GenProton.Eta", GenProton_Eta, &b_GenProton_Eta);
   fChain->SetBranchAddress("GenProton.Phi", GenProton_Phi, &b_GenProton_Phi);
   fChain->SetBranchAddress("GenProton.Rapidity", GenProton_Rapidity, &b_GenProton_Rapidity);
   fChain->SetBranchAddress("GenProton.T", GenProton_T, &b_GenProton_T);
   fChain->SetBranchAddress("GenProton.X", GenProton_X, &b_GenProton_X);
   fChain->SetBranchAddress("GenProton.Y", GenProton_Y, &b_GenProton_Y);
   fChain->SetBranchAddress("GenProton.Z", GenProton_Z, &b_GenProton_Z);
   fChain->SetBranchAddress("GenProton_size", &GenProton_size, &b_GenProton_size);
